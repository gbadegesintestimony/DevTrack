  ...
  return (
    <div className="min-h-screen bg-background text-slate-100 flex flex-col bg-grid-pattern relative selection:bg-primary-500/20 selection:text-primary-300">
      ...
      <footer className="border-t border-surface-border/60 bg-surface/40 py-6 mt-12">
        <div className="w-full max-w-[1700px] mx-auto px-4 sm:px-8 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400 font-mono">
          ...
          <div className="flex items-center gap-4 text-slate-400">
            ...
            <span className="flex items-center gap-1.5">
              <Database className="w-3 h-3 text-indigo-400" /> PostgreSQL + Prisma
            </span>
            <span className="flex items-center gap-1.5">
